...
print("Interface Name\tInterface Node\tRemote Node\tUtilization")
...
print()
print(
    "After failing {}, here are the LSPs and their "
...
model.update_simulation()
print(
    "After adding demand, here are the LSPs and their "
...
print()
print(
    "Here are the routed LSPs and their reserved_bandwidth and baseline_path_reservable_bw values "
)
for lsp in model.rsvp_lsp_objects:
...
print(
    "Here are the routed LSPs and their reserved_bandwidth, setup_bandwidth, and baseline_path_reservable_bw values "
)
for lsp in model.rsvp_lsp_objects:
    if "Unrouted" not in lsp.path:
        print(
...
model.update_simulation()
print("Here are all the LSPs and their reserved_bandwidth and setup_bandwidth")
for lsp in model.rsvp_lsp_objects:
    print([lsp.lsp_name, lsp.reserved_bandwidth, lsp.setup_bandwidth])
