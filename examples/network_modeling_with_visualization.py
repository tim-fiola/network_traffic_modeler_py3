...
print(
    "Failing node E and interface B-to-D on node B and displaying " "a network graph:"
)
model1.fail_node("E")
model1.fail_interface("B-to-D", "B")
model1.update_simulation()
...
try:
    ...
    print(
        "The WeatherMap class is a beta feature and requires additional packages to be "
