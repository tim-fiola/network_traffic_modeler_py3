...
print(
    "int_a_b percent_reservable_bandwidth = {}".format(
        int_a_b.percent_reservable_bandwidth
    )
)
...
print(
    "int_a_b reserved_bandwidth + reservable_bandwidth = {}".format(
        int_a_b.reserved_bandwidth + int_a_b.reservable_bandwidth
    )
)
