...
network_interfaces = [
    ...
    {'name': 'A-to-D', 'cost': 8, 'capacity': 150, 'node': 'A',
     'remote_node': 'D', 'circuit_id': 4, 'failed': False},
    {'name': 'B-to-A', 'cost': 4, 'capacity': 100, 'node': 'B',
     'remote_node': 'A', 'circuit_id': 1, 'failed': False},
    {'name': 'B-to-D', 'cost': 7, 'capacity': 200, 'node': 'B',
     'remote_node': 'D', 'circuit_id': 5, 'failed': False},
    {'name': 'B-to-E', 'cost': 3, 'capacity': 200, 'node': 'B',
     'remote_node': 'E', 'circuit_id': 8, 'failed': False},
    {'name': 'D-to-B', 'cost': 7, 'capacity': 200, 'node': 'D',
     'remote_node': 'B', 'circuit_id': 5, 'failed': False},
    {'name': 'D-to-C', 'cost': 6, 'capacity': 150, 'node': 'D',
     'remote_node': 'C', 'circuit_id': 6, 'failed': False},
    {'name': 'D-to-A', 'cost': 8, 'capacity': 150, 'node': 'D',
     'remote_node': 'A', 'circuit_id': 4, 'failed': False},
    {'name': 'D-to-E', 'cost': 4, 'capacity': 100, 'node': 'D',
     'remote_node': 'E', 'circuit_id': 9, 'failed': False},
    {'name': 'D-to-F', 'cost': 3, 'capacity': 100, 'node': 'D',
     'remote_node': 'F', 'circuit_id': 10, 'failed': False},
    {'name': 'C-to-A', 'cost': 1, 'capacity': 200, 'node': 'C',
     'remote_node': 'A', 'circuit_id': 3, 'failed': False},
    {'name': 'C-to-D', 'cost': 6, 'capacity': 150, 'node': 'C',
     'remote_node': 'D', 'circuit_id': 6, 'failed': False},
    {'name': 'E-to-B', 'cost': 3, 'capacity': 200, 'node': 'E',
     'remote_node': 'B', 'circuit_id': 8, 'failed': False},
    {'name': 'E-to-D', 'cost': 4, 'capacity': 100, 'node': 'E',
     'remote_node': 'D', 'circuit_id': 9, 'failed': False},
    {'name': 'F-to-D', 'cost': 3, 'capacity': 100, 'node': 'F',
     'remote_node': 'D', 'circuit_id': 10, 'failed': False},
]


network_interfaces_w_errors = [
    {'name': 'A-to-B', 'cost': 4.1, 'capacity': 100, 'node': 'A',
     'remote_node': 'B', 'circuit_id': 1, 'failed': 'moo'},  # bad 'failed', non int metric
    ...
    {'name': 'B-to-Av2', 'cost': 40, 'capacity': 150, 'node': 'B',
     'remote_node': 'A', 'circuit_id': 2, 'failed': False},
    {'name': 'B-to-D', 'cost': 7, 'capacity': 200, 'node': 'B',
     'remote_node': 'D', 'circuit_id': 5, 'failed': False},
    {'name': 'B-to-E', 'cost': 3, 'capacity': 200, 'node': 'B',
     'remote_node': 'E', 'circuit_id': 8, 'failed': False},
    ...
    {'name': 'D-to-C_v2', 'cost': 6, 'capacity': 200, 'node': 'D',
     'remote_node': 'C', 'circuit_id': 11, 'failed': False},
    {'name': 'D-to-A', 'cost': 8, 'capacity': 150, 'node': 'D',
     'remote_node': 'A', 'circuit_id': 4, 'failed': False},
    {'name': 'D-to-E', 'cost': 4, 'capacity': 100, 'node': 'D',
     'remote_node': 'E', 'circuit_id': 9, 'failed': False},
    ...
    {'name': 'C-to-D_v2', 'cost': 6, 'capacity': 200, 'node': 'C',
     'remote_node': 'D', 'circuit_id': 11, 'failed': False},
    {'name': 'E-to-B', 'cost': 3, 'capacity': 200, 'node': 'E',
     'remote_node': 'B', 'circuit_id': 8, 'failed': False},
    {'name': 'E-to-D', 'cost': 4, 'capacity': 100, 'node': 'E',
     'remote_node': 'D', 'circuit_id': 9, 'failed': False},
    ...
    {'name': 'Z-to-D', 'cost': 3, 'capacity': 100, 'node': 'Z',
     'remote_node': 'D', 'circuit_id': 10, 'failed': False},  # no remote interface
]
