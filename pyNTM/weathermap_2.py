...
class WeatherMap(object):  # noqa C901
    ...
    no_selected_demand_text = 'no routed demand selected'
    no_selected_lsp_text = 'no routed lsp selected'
    ...
    failed_interface_color = 'dimgrey'
