...
class TestCircuit(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual(
            repr(self.circuit),
            "Circuit(Interface(name = 'inerfaceA-to-B', cost = 4, capacity = 100, node_object = Node('nodeA'), "
            "remote_node_object = Node('nodeB'), circuit_id = 1), Interface(name = 'inerfaceB-to-A', cost = 4, "
            "capacity = 100, node_object = Node('nodeB'), remote_node_object = Node('nodeA'), circuit_id = 1))",
        )  # noqa E501
