...
class TestModel(unittest.TestCase):
    ...
    def test_demand_add(self):
        ...
        model.update_simulation()
        self.assertEqual(model.__repr__(), 'Model(Interfaces: 2, Nodes: 2, Demands: 1, RSVP_LSPs: 0)')
    ...
    def test_rsvp_lsp_add(self):
        ...
        # model.add_demand('nodeA', 'nodeB', 40, 'dmd_a_b')
        # model.update_simulation()
        model.add_rsvp_lsp('nodeA', 'nodeB', 'lsp_a_b_1')
        model.update_simulation()
        self.assertEqual(model.__repr__(), 'Model(Interfaces: 2, Nodes: 2, Demands: 1, RSVP_LSPs: 1)')
