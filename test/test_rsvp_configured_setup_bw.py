...
class TestRSVPLSPConfigSetupBW(unittest.TestCase):
    ...
    def test_lsp_dmds(self):
        ...
        self.assertEqual(
            set(lsp_a_d_1.demands_on_lsp(model)), set([dmd_a_d_1, dmd_a_d_2])
        )
        self.assertEqual(
            set(lsp_a_d_2.demands_on_lsp(model)), set([dmd_a_d_1, dmd_a_d_2])
        )
        self.assertEqual(
            set(lsp_a_d_3.demands_on_lsp(model)), set([dmd_a_d_1, dmd_a_d_2])
        )
